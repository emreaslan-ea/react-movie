...
function MoviePart(){
    ...
    return(
        <div className='relative z-30' >
            ...
            <img id='moviePart' className='-z-20 absolute h-[24rem] md:h-fit' src={`https://www.themoviedb.org/t/p/w1920_and_h800_multi_faces/${movieDetail.backdrop_path}`}alt=""/>
            <img className='absolute -z-10 w-full h-[24rem] md:h-fit aspect-[12/5]' alt="" src="https://imgs.search.brave.com/pVL4eQl5R1V8wtwjMhxzt9Zmx3xANfKzBIywIjSqhrI/rs:fit:1200:1144:1/g:ce/aHR0cHM6Ly93d3cu/ZGFuY2V3aXRobWUu/dXMvd3AtY29udGVu/dC91cGxvYWRzLzIw/MTgvMDMvYmxhY2st/ZmFkZS1mdWxsLnBu/Zw"></img>
         
            <div className='z-30 w-full mx-auto lg:w-2/3 flex lg:flex-row flex-col items-center lg:items-start p-5  lg:pt-96 pt-64'>

                <div className='lg:w-1/5 md:w-1/4 w-1/2 max-w-full basis-1/4 lg:mr-4 flex flex-col items-center'>
                    <img className='rounded-lg  object-cover justify-self-center' alt="" src={posterUrl}/>
                    
                    <div className='flex items-center justify-evenly w-full mt-4'>
                        <div className='flex items-center'>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-7 h-7 fill-red-700">
                                <path d="M9.653 16.915l-.005-.003-.019-.01a20.759 20.759 0 01-1.162-.682 22.045 22.045 0 01-2.582-1.9C4.045 12.733 2 10.352 2 7.5a4.5 4.5 0 018-2.828A4.5 4.5 0 0118 7.5c0 2.852-2.044 5.233-3.885 6.82a22.049 22.049 0 01-3.744 2.582l-.019.01-.005.003h-.002a.739.739 0 01-.69.001l-.002-.001z" />
                            </svg>
                            <p className='text-xs text-white'>{movieDetail.vote_count}</p>
                        </div>
                        <div className='flex items-center'>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-7 h-7 fill-orange-600">
                        ...
                        <div className='flex items-center'>
                            <svg className='fill-yellow-500 w-7 h-7' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
                ...
                <div className='lg:max-w-xl w-full lg:ml-4 px-8 lg:px-0 pt-12 md:pt-0'>
